    ...
    public partial class Usc_TraCuuTheoTheloai_TuaSach : UserControl
    {
        ...
        void XoaTuaSach(string MaTuaSach)
        {
            ...
            switch (kq)
            {
                ...
                case 1:
                    {
                        MessageBox.Show("Xóa Thất Bại.Có mã đầu sách thuộc Mã tựa sách này", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        txtMaTuaSach.Focus();
                        break;
                    }
                case 2:
                    {
                        MessageBox.Show("Không Tồn Tại tựa sách", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaTuaSach.Focus();
                        break;
                    }
        ...
        void ThemThongTinTuaSach(string MaTuaSach, string TenTuaSach, string MaTheLoai, string MaTacGia, string NDTomTat)
        {
            ...
            switch (kq)
            {
                ...
                case 2:
                    {
                        MessageBox.Show("trùng mã tựa sách", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaTuaSach.Focus();
                        break;
                    }
                case 3:
                    {
                        MessageBox.Show("Không Có tên thể loại ,Kiểm tra lại!!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        break;
                    }
                case 4:
                    {
                        MessageBox.Show("Không Có tên tác giả ,Kiểm tra lại!!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        break;
                    }
            }
        }
        ...
        void CapNhatThongTinTuaSach(string MaTuaSach, string TenTuaSach, string MaTheLoai, string MaTacGia, string NDTomTat)
        {
            ...
            switch (kq)
            {
                ...
                case 2:
                    {
                        MessageBox.Show("Không Có Mã tựa sách", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaTuaSach.Focus();
                        break;
                    }
                case 3:
        ...
        void XoaTheLoai(string MaTheLoai)
        {
            ...
            switch (kq)
            {
                ...
                case 2:
                    {
                        MessageBox.Show("Không Tồn Tại Mã thể loại", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaTheLoai.Focus();
                        break;
                    }
                case 3:
                    {
                        MessageBox.Show("Không thể xóa.Mã thể loại này c1 trong bảng tựa sách", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaTheLoai.Focus();
                        break;
                    }
        ...
        void CapNhatThongTheLoai(string MaTheLoai, string TenTheLoai)
        {
            ...
            switch (kq)
            {
                ...
                case 2:
                    {
                        MessageBox.Show("Không Có Mã thể loại", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaTuaSach.Focus();
                        break;
                    }
                case 3:
                    {
                        MessageBox.Show("Có mã thể loại này trong tựa sách.không cập nhật  được", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        break;
                    }
        ...
        void ThemThongTheLoai(string MaTheLoai, string TenTheLoai)
        {
            ...
            switch (kq)
            {
                ...
                case 2:
                    {
                        MessageBox.Show("Mã thể loại đã tồn tại", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaTheLoai.Focus();
                        break;
                    }
        ...
        private void Usc_TraCuuTheoTheloai_TuaSach_Load(object sender, EventArgs e)
        {
                HienThiThongTinTuaSach();
                HienThiThongTheLoai();
        ...
        private void btnXoaTS_Click(object sender, EventArgs e)
        {
            if (txtMaTuaSach.Text.Trim() == "")
            {
                MessageBox.Show("Chưa Nhập Mã tựa sách", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtMaTuaSach.Focus();
                return;
            }
        ...
        private void btnCapNhatTS_Click(object sender, EventArgs e)
        {
            ...
            if (txtMaTuaSach.Text.Trim() == "")
            {
                MessageBox.Show("Chưa Nhập Mã  tựa sách", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtMaTuaSach.Focus();
                return;
            }
            if (txtTenTuaSach.Text.Trim() == "")
            {
                MessageBox.Show("Chưa Nhập Tên tựa sách", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtTenTuaSach.Focus();
                return;
            }
            ...
            {
                MessageBox.Show("Chưa Nhập tác giả", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                cboMaTacGia.Focus();
                return;
            }
            if (cboMaTheLoai.Text.Trim() == "")
            {
                MessageBox.Show("Chưa Nhập thể loại", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                cboMaTheLoai.Focus();
                return;
            }
