    ...
    public partial class Usc_TraCuuTheoNXB_TacGia : UserControl
    {
        ...
        void XoaNXB(string MaNSX)
        {
            ...
            switch (kq)
            {
                ...
                case 2:
                    {
                        MessageBox.Show("Không Tồn Tại Mã nhà sản xuất", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaNXB.Focus();
                        break;
                    }
                case 3:
                    {
                        MessageBox.Show("Mã nhà xuất bản có trong bảng đầu sach", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaNXB.Focus();
                        break;
                    }
            }
        ...
        void XoaTacGia(string MaTacGia)
        {
            ...
            switch (kq)
            {
                ...
                case 2:
                    {
                        MessageBox.Show("Không Tồn Tại Mã tác giả", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaNXB.Focus();
                        break;
                    }
                case 3:
                    {
                        MessageBox.Show("Mã tác giả có trong bảng tựa sách", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaNXB.Focus();
                        break;
                    }
            }
        ...
        void LuuMoiNXB(string MaNSX, string TenNSX)
        {
            ...
            switch (kq)
            {
                ...
                case 2:
                    {
                        MessageBox.Show("Trùng Mã nhà sản xuất", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaNXB.Focus();
                        break;
                    }
        ...
        void LuuMoiTacGia(string MaTacGia, string TenTacGia)
        {
            ...
            switch (kq)
            {
                ...
                case 2:
                    {
                        MessageBox.Show("Trùng Mã tác giả", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaTacGia.Focus();
                        break;
                    }
        ...
        void CapNhatTacGia(string MaTacGia, string TenTacGia)
        {
            ...
            switch (kq)
            {
                case 0:
                    {
                        MessageBox.Show("Cập nhật Thành Công", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        HienThiTacGia();
                        break;
                    }
                case 1:
                    {
                        MessageBox.Show("Cập nhật Thất Bại", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        break;
                    }
                case 2:
                    {
                        MessageBox.Show("Không có Mã tác giả trong bảng Tác giả", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaTacGia.Focus();
                        break;
                    }
                case 3:
                    {
                        MessageBox.Show("Mã tác giả có  trong bảng Tựa sách", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaTacGia.Focus();
                        break;
                    }
        ...
        void CapNhatNSX(string MaNSX, string TenNSX)
        {
            ...
            switch (kq)
            {
                ...
                case 2:
                    {
                        MessageBox.Show("Không có Mã nhà sản xuất trong bảng Nhà sản xuất", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaNXB.Focus();
                        break;
                    }
                case 3:
                    {
                        MessageBox.Show("Mã nhà sản xuất có  trong bảng Đầu sách", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        txtMaNXB.Focus();
                        break;
                    }
        ...
        private void btnXoaNXB_Click(object sender, EventArgs e)
        {
            if (txtMaNXB.Text.Trim() == "")
            {
                MessageBox.Show("Chưa Nhập Mã Nhà xuất bản", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtMaNXB.Focus();
                return;
            }
        ...
        private void Usc_TraCuuTheoNXB_TacGia_Load(object sender, EventArgs e)
        {
            HienThiNSX();
            HienThiTacGia();
        ...
        private void btnXoaTG_Click(object sender, EventArgs e)
        {
            if (txtMaTacGia.Text.Trim() == "")
            {
                MessageBox.Show("Chưa Nhập Mã tác giả", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtMaTacGia.Focus();
                return;
            }
        ...
        private void btnLuuNXB_Click(object sender, EventArgs e)
        {
            if (txtMaNXB.Text.Trim() == "")
            {
                MessageBox.Show("Chưa Nhập Mã tác giả", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtMaNXB.Focus();
                return;
            }
            if (txtTenNXB.Text.Trim() == "")
            {
                MessageBox.Show("Chưa Nhập tên tác giả", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtTenNXB.Focus();
                return;
            }
        ...
        private void btnCapNhatNXB_Click(object sender, EventArgs e)
        {
            if (txtMaNXB.Text.Trim() == "")
            {
                MessageBox.Show("Chưa Nhập Mã  nhà xuất bản", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtMaNXB.Focus();
                return;
            }
            if (txtTenNXB.Text.Trim() == "")
            {
                MessageBox.Show("Chưa Nhập Tên nhà xuất bản", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtTenNXB.Focus();
                return;
            }
